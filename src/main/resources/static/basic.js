                      ...
                      <div class="card-body">
                        ...
                        <div class="editpart">
                            ...
                            <div class="footer">
                                ...
                                <img id="${memo.id}-delete1" class="icon-delete" src="images/delete.png" alt="" onclick="deletePost('${memo.id}')">
                                <img id="${memo.id}-delete" class="icon-delete" style="display: none" src="images/delete.png" alt="" onclick="deleteOne('${memo.id}')">
